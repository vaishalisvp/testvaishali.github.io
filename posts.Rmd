...
### [The gendered impact of parental separation on adolescent wellbeing in Germany - fixed effects regression analysis](./mastersthesis.html)
...
The code for this analysis can be found [here](https://github.com/vaishalisvp/masters-thesis).

&nbsp;
&nbsp;


### [#metoo - text scraping/sentiment analysis](./metoo.html)
...
The code for this analysis can be found [here](https://github.com/vaishalisvp/metoo-analysis).
...
### [FRIENDS - sentiment analysis](./friends.html)
...
The code for this analysis can be found [here](https://github.com/vaishalisvp/FRIENDS-sentiment-analysis).
